...
class MIPV1DeviceDidAddService: MIPV1DeviceNotification {

    var type : MIPV1DeviceNotificationType { return .didAddService }
    ...
    required init(from decoder: Decoder) throws
    {
        ...
        service = try container.decode(ServiceProfile.self, forKey: .service)
    }
    ...
    {
        client.device(device, didAddService: service)
    }
