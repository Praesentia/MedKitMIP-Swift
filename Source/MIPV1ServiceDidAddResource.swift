...
class MIPV1ServiceDidAddResource: MIPV1ServiceNotification {

    var type : MIPV1ServiceNotificationType { return .didAddResource }
    ...
    init(_ resource: ResourceProfile)
    {
    ...
    required init(from decoder: Decoder) throws
    {
        ...
        resource = try container.decode(ResourceProfile.self, forKey: .resource)
    }
    ...
    {
        client.service(service, didAddResource: resource)
    }
